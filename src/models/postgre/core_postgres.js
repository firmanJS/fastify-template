...
exports.insert = async (options) => {
  const [result] = await PG(options?.table).insert(options?.payload).returning(options?.column)
  return result
}
/**
 *
...
exports.insertTrx = async (options) => {
  const [result] = await PG(options?.table).transacting(options?.trx).insert(options?.payload)
...
const fetchByParam = async (options) => {
  const result = await PG(options?.table).where(options?.where).select(options?.column)
  return result
}
/**
 *
...
exports.updated = async (options) => {
  ...
  const [result] = await PG(options?.table).where(options?.where).update(options?.payload).returning(options?.column)
...
exports.deletePermanently = async (options) => {
  const [result] = await PG(options?.table).where(options?.where).del().returning(options?.column)
  return result
}
/**
 *
...
exports.raw = async (query) => {
  const result = await PG.raw(query)
